...
public class ShowIncome extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
	        ...
	        String input1=request.getParameter("date");
//	        String input2=request.getParameter("date1");
//	        String input3=request.getParameter("date2");
	        
	        DayilyIncome income1=null;
			try {
				income1 = getIncome(input1);
...
//	        DayilyIncome income2=getIncome(input2,input3);
	...
	//		request.setAttribute("income2", income2);
	  ...
	  public DayilyIncome getIncome(String input) throws ParseException, SQLException{
	        ...
	        String year =""+(int)date.get(Calendar.YEAR);
	        String month=""+(int)(date.get(Calendar.MONTH)+1);
	        String day=""+(int)date.get(Calendar.DATE);
	        
	        DayilyIncome income=ToDayilyIncome.getByDate(year,month,day);
