...
<body>
  ...
  <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
	<span class="glyphicon glyphicon-menu-right" ></span>
						...
						<script>
		function recieveFines(){
			document.getElementById("RecieveFiness").submit();
		}
	</script>
						<div>
							<row>
							<form method="post" action="RecieveFines" id="RecieveFiness">

								<div
									style="float: left; font-size: 18px; color: #002A5A; width: 10%;">Reader
									ID :</div>
								<input name="useraccount" type="text" class="form-control"
									placeholder="Input Reader Id" aria-describedby="sizing-addon1">
					  ...
					  <input  name="useraccount" type="text" class="form-control" placeholder="Input UserAccount" aria-describedby="sizing-addon1"-->
									...
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<button type="submit" class="btn btn-primary"
												onclick="recieveFines()">Submit now</button>
										</div>
									</div>
								</div>
							</div>
							...
							<c:if test="${fine == 0.0}">
								<div class="modal-body">
									<h4 style="color: #002A5A">This reader has no fine!!</h4>
							 ...
							 <c:if test="${ifAccountExists == 0}">
								<div class="modal-body">
									<h4 style="color: #002A5A">Cannot find this account!</h4>
